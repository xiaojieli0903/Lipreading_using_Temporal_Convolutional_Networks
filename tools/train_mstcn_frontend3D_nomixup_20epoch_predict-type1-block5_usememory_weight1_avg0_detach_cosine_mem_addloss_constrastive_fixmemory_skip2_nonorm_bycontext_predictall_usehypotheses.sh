MODEL_JSON_PATH=configs/lrw_resnet18_mstcn_frontend3D_predict-future-type1-block5-skip2_usememory_mvm_fixmemory_nonorm_bycontext_predictall_usehypotheses.json
