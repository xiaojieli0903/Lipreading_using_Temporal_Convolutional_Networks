...
CUDA_VISIBLE_DEVICES=2 python main.py --modality video \
				      ...
				      --predict-loss-type 'cosine' --add-memory-loss --model-path /home/gao2/Lipreading_using_Temporal_Convolutional_Networks/train_logs/tcn/lrw_resnet18_mstcn_frontend3D_predict-future-type1-block7_usememory_mvm_fixmemory_bycontext_nonorm_nomixup_20epochs_lw1_avg0_cosine_addloss_contrastive_v3/ckpt.pth --init-epoch 1
