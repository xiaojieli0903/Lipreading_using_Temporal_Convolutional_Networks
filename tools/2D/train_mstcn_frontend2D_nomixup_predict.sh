MODEL_JSON_PATH=configs/lrw_resnet18_mstcn_frontend2D_predict-future.json
...
CUDA_VISIBLE_DEVICES=2 python main.py --modality video \
				      ...
				      --alpha 0 \
				      --exp-name _nomixup \
				      --model-path /disk/gao2/work_dirs/train_logs/tcn/lrw_resnet18_mstcn_frontend2D_predict-future_nomixup/2022-10-10T18:11:49//ckpt.pth \
				      --init-epoch 1
