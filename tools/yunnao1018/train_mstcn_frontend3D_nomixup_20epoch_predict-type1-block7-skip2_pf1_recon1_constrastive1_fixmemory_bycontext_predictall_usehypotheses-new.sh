MODEL_JSON_PATH=configs/lrw_resnet18_mstcn_frontend3D_predict-future-type1-block7-skip2_usememory_mvm_fixmemory_bycontext_predictall_usehypotheses.json
...
CUDA_VISIBLE_DEVICES=2 python main.py --modality video \
				      ...
				      --alpha 0 --epochs 20 \
				      --exp-name _nomixup_20epochs_pf1_recon1_contrastive1-new \
