...
CUDA_VISIBLE_DEVICES=2 python main.py --modality video \
				      ...
				      --alpha 0 --epochs 20 \
				      --exp-name _nomixup_20epoch_hypo-cont0.01_match-global0.01 \
				      --mvm-hypo-contrastive-loss-weight 0.01 --mvm-match-global-loss-weight 0.01 \
                                      --init-epoch 1 --model-path /disk/gao2/work_dirs/train_logs/tcn/lrw_resnet18_mstcn_frontend3D_block7-skip2_mvm_bycontext_predictall_usehypotheses_contrastive-hypo_match-global_nomixup_20epoch_hypo-cont0.01_match-global0.01/ckpt.pth
